...
BASE_TEMPLATES = [
    ...
    # ----------------------------------------------------
    # 12. Critical Campus Emergency Incidents (35 base templates)
    # High-severity physical danger, fire, structural, gas, electrical, chemical hazards
    # ----------------------------------------------------
    ("T_EMG_001", "Active fire and dense smoke spreading in the organic chemistry fume hood.", "Safety", "Critical"),
    ("T_EMG_002", "Central elevator freefell two floors and passengers are trapped inside with injuries.", "Maintenance", "Critical"),
    ("T_EMG_003", "Main structural ceiling beam in the sports hall has cracked and is dropping heavy concrete debris.", "Maintenance", "Critical"),
    ("T_EMG_004", "Severed high-voltage power cable is whipping and sparking on the flooded courtyard walkway.", "Electrical", "Critical"),
    ("T_EMG_005", "Severe toxic chlorine gas leak detected from the aquatic center filtration plant.", "Safety", "Critical"),
    ("T_EMG_006", "Underground gas main pipeline ruptured with loud hissing near student residential dining hall.", "Safety", "Critical"),
    ("T_EMG_007", "Live 400V electrical wire touching metal staircase handrail is shocking students.", "Electrical", "Critical"),
    ("T_EMG_008", "Violent chemical explosion in research synthesis lab with shattered glass and injured technician.", "Safety", "Critical"),
    ("T_EMG_009", "Industrial steam boiler pressure gauge in red zone emitting screeching steam with imminent burst risk.", "Plumbing", "Critical"),
    ("T_EMG_010", "Main campus data center UPS battery bank in thermal runaway emitting acrid toxic fumes.", "IT", "Critical"),
    ("T_EMG_011", "Severe flash flooding rapidly submerging basement computer laboratory trapping students.", "Safety", "Critical"),
    ("T_EMG_012", "Fourth floor concrete balcony balustrade has detached and is hanging precariously over walkway.", "Maintenance", "Critical"),
    ("T_EMG_013", "Outdoor step-down electrical transformer exploded into flames directly beside Block B dormitory.", "Electrical", "Critical"),
    ("T_EMG_014", "Concentrated nitric acid carboy shattered across laboratory floor producing choking nitrogen dioxide fumes.", "Safety", "Critical"),
    ("T_EMG_015", "High-pressure medical oxygen cylinder valve sheared off inside campus health clinic.", "Safety", "Critical"),
    ("T_EMG_016", "Emergency fire exit in lecture theater is chained shut while smoke alarm is blaring.", "Safety", "Critical"),
    ("T_EMG_017", "Load-bearing support pillar on Block C fifth floor shows massive diagonal shear fracture.", "Maintenance", "Critical"),
    ("T_EMG_018", "Out-of-control campus vehicle smashed through security barrier into crowded pedestrian plaza.", "Safety", "Critical"),
    ("T_EMG_019", "Arc flash explosion inside main 11kV electrical distribution substation knocked technician unconscious.", "Electrical", "Critical"),
    ("T_EMG_020", "Heavy pressurized argon cylinder ruptured launching across mechanical engineering workshop floor.", "Safety", "Critical"),
    ("T_EMG_021", "Smoke and flames venting from elevator shaft into fourth floor residential dorm corridor.", "Safety", "Critical"),
    ("T_EMG_022", "High concentration carbon monoxide detector sounding continuous evacuation siren in underground parking.", "Safety", "Critical"),
    ("T_EMG_023", "Two-ton sliding iron entrance gate slipped off track and pinned a student.", "Safety", "Critical"),
    ("T_EMG_024", "Rapidly spreading polymer fire inside engineering rapid prototyping 3D printing lab.", "Safety", "Critical"),
    ("T_EMG_025", "Submerged electrical power distribution strip in standing water inside flooded science washroom.", "Electrical", "Critical"),
    ("T_EMG_026", "Sawdust combustible explosion occurred in campus carpentry workshop with burning embers.", "Safety", "Critical"),
    ("T_EMG_027", "Heavy construction scaffolding on exterior facade partially collapsed blocking main building exit.", "Maintenance", "Critical"),
    ("T_EMG_028", "Rooftop water storage tank structural cradle failed threatening roof collapse over lecture hall.", "Facilities", "Critical"),
    ("T_EMG_029", "Autoclave pressure vessel exploded in biological sciences building shattering adjacent walls.", "Safety", "Critical"),
    ("T_EMG_030", "Exploding aerosol spray canisters inside dormitory incinerator chute ignited surrounding garbage.", "Safety", "Critical"),
    ("T_EMG_031", "Lightning strike ignited structural roof trusses of academic Block A.", "Safety", "Critical"),
    ("T_EMG_032", "Chemical fume extraction system stopped running while volatile cyanide compounds were being handled.", "Safety", "Critical"),
    ("T_EMG_033", "Industrial ammonia refrigeration leak in campus food cold-storage warehouse.", "Safety", "Critical"),
    ("T_EMG_034", "Floor ceiling collapse in student common room with falling masonry and exposed rebar.", "Maintenance", "Critical"),
    ("T_EMG_035", "Main electrical switchboard room caught fire plunging campus hospital block into total blackout.", "Electrical", "Critical"),
]
